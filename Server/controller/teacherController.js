...
exports.regTeachers = async (req , res) => {
    ...
    if(teacher) 
        return res.send({status:400,message:'TEACHER ALREADY REGISTERED'});
    ...
    res.send({status:200,message:"TEACHER REGISTRATION SUCCESSFUL",payload:_.pick(teacher, ['_id' , 'name', 'email'])});
};
