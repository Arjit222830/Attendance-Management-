...
exports.regStudents = async (req , res) => {
    ...
    if(student) 
        return res.send({status:400,message:'STUDENT ALREADY REGISTERED'});
    ...
    res.send({status:200,message:"STUDENT REGISTRATION SUCCESSFUL",payload:_.pick(student, ['_id' , 'name', 'email'])});
};
